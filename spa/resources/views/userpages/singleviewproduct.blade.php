        ...
        <div class="unit unit-spacimg-md unit-xs-horizontal unit-align-center unit-middle">
          <div>
            ...
            <div class="unit-body">
              ...
              @if ($count==1)
              <a class="btn btn-sm box-service-control" data-toggle="modal" data-target="#mymodal">edit my review</a>
              @else
              <a class="btn btn-sm box-service-control" data-toggle="modal" data-target="#mymodal">write review</a>
              @endif
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label>Write your product reviews here...</label>
      </div>
      <div class="modal-footer">
        ...
        <form class="login100-form validate-form" style="padding-bottom:3em;" method="POST" action="{{ route('productfeedback') }}">
          ...
          <textarea class="form-control  form-control-has-validation" id="billing-last-name" rows="5" cols="70" name="productfeed" required="required">{{$msg}}</textarea>
          ...
          <div class="unit-body">
            ...
            <button type="submit" class="btn btn-sm box-service-control">write review</button></div>
      </div>
    </div>
    </form>
  </div>
