      ...
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          <div class="page-header page-header-perspective">
            <div class="page-header-left"><a class="brand" href="index.html"><img src="images/logo-default-199x36.png" alt="" width="199" height="36"/></a></div>
              ...
              <div class="shell">
                ...
                <div class="range range-50">
                  <div class="cell-xs-6 cell-md-3">
                    <article class="card-service-option"><img class="card-service-option-image" src="images/icon-service-1-70x62.png" alt="" width="70" height="62"/>
                      <p class="card-service-option-title">TRADITIONAL HAIRCUTS</p>
                      <div class="card-service-option-panel">
                        <p class="card-service-option-text">One of the most popular services our barbers provide</p><a class="btn btn-xs card-service-option-control" href="step-2.html">Choose</a>
                      </div>
                    </article>
                  </div>
                  <div class="cell-xs-6 cell-md-3">
                    <article class="card-service-option"><img class="card-service-option-image" src="images/icon-service-2-70x62.png" alt="" width="70" height="62"/>
                      <p class="card-service-option-title">SHAVES</p>
                      <div class="card-service-option-panel">
                        <p class="card-service-option-text">Our shaving services will make you look really handsome</p><a class="btn btn-xs card-service-option-control" href="step-2.html">Choose</a>
                      </div>
                    </article>
                  </div>
                  <div class="cell-xs-6 cell-md-3">
                    <article class="card-service-option"><img class="card-service-option-image" src="images/icon-service-3-70x62.png" alt="" width="70" height="62"/>
                      <p class="card-service-option-title">beard trim</p>
                      <div class="card-service-option-panel">
                        <p class="card-service-option-text">Well-trimmed beard is a must-have element of every men’s image</p><a class="btn btn-xs card-service-option-control" href="step-2.html">Choose</a>
                      </div>
                    </article>
                  </div>
                  <div class="cell-xs-6 cell-md-3">
                    <article class="card-service-option"><img class="card-service-option-image" src="images/icon-service-4-70x62.png" alt="" width="70" height="62"/>
                      <p class="card-service-option-title">Mustache trim</p>
                      <div class="card-service-option-panel">
                        <p class="card-service-option-text">Mustaches also need to be trimmed regularly</p><a class="btn btn-xs card-service-option-control" href="step-2.html">Choose</a>
                      </div>
                    </article>
                  </div>
                </div>
