...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <script src="theam/cdn-cgi/apps/head/3ts2ksMwXvKRuG480KNifJ2_JNM.js"></script><link rel="icon" href="theam/images/favicon.ico" type="image/x-icon">
    <!-- Stylesheets-->
    ...
    <link rel="stylesheet" href="theam/css/style.css">
		<!--[if lt IE 10]>
    <div style="background: #212121; padding: 10px 0; box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3); clear: both; text-align:center; position: relative; z-index:1;"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="theam/images/ie8-panel/warning_bar_0000_us.jpg" border="0" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
  ...
  <body>
      ...
      <main class="page-content" id="perspective">
        <div class="content-wrapper">
          ...
          <div id="wrapper">
                ...
                <div class="shell">
                  <div class="range range-sm-center">
                    <div class="cell-sm-10 cell-lg-9"><a class="brand-big" href="index.html"><img src="theam/images/logo-md-white-136x160.png" alt="" width="136" height="160"/></a>
                      ...
                      <p class="large">At Spa, you will find an atmosphere of old school sophistication with modern amenities.We cater to gentlemen on the go. So stop in on your lunch break to get an old-fashioned straight razor shave or a perfect haircut.</p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="range range-30">
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="theam/images/icon-service-1-70x62.png" alt="" width="70" height="62"/>
                          </figure>
                      ...
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="theam/images/icon-service-2-70x62.png" alt="" width="70" height="62"/>
                          </figure>
                      ...
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="theam/images/icon-service-3-70x62.png" alt="" width="70" height="62"/>
                          </figure>
                      ...
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="theam/images/icon-service-4-70x62.png" alt="" width="70" height="62"/>
                          </figure>
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                <article class="box-promo">
                  <div class="box-promo-left"><img class="box-promo-image" src="theam/images/home-1-585x580.jpg" alt="" width="585" height="580"/>
                  </div>
                  ...
                  <div class="cell-xs-12">
                    <div class="range range-30">
                      <div class="cell-sm-6 cell-md-4 height-fill">
                        <div class="thumbnail-card"><img class="thumbnail-card-image" src="theam/images/barbers-1-370x310.jpg" alt="" width="370" height="310"/>
                      ...
                      <div class="cell-sm-6 cell-md-4 height-fill">
                        <div class="thumbnail-card"><img class="thumbnail-card-image" src="theam/images/barbers-2-370x310.jpg" alt="" width="370" height="310"/>
                          <div class="thumbnail-card-body">
                      ...
                      <div class="cell-sm-6 cell-md-4 height-fill">
                        <div class="thumbnail-card"><img class="thumbnail-card-image" src="theam/images/barbers-3-370x310.jpg" alt="" width="370" height="310"/>
                          <div class="thumbnail-card-body">
            ...
            <section class="section-xxl bg-gray-dark bg-gray-dark-overlay bg-image" style="background-image: url(theam/images/bg-image-3.jpg);">
              <div class="shell">
                <div class="range">
                  ...
                  <div class="cell-xs-12">
                    ...
                    <div class="owl-carousel owl-carousel-modern owl-spacing-1" data-items="1" data-stage-padding="0" data-loop="true" data-margin="20" data-xs-margin="30" data-mouse-drag="false" data-nav="true" data-dots="true" data-animation-in="fadeIn" data-animation-out="fadeOut">
                      <div class="item">
                                    <blockquote class="quote-fullwidth">
                                      <div class="quote-fullwidth-left">
                                        <div class="quote-fullwidth-avatar"><img src="theam/images/testimonials-1-100x100.jpg" alt="" width="100" height="100"/>
                                        </div>
                                      </div>
                      ...
                      <div class="item">
                                    <blockquote class="quote-fullwidth">
                                      <div class="quote-fullwidth-left">
                                        <div class="quote-fullwidth-avatar"><img src="theam/images/testimonials-2-100x100.jpg" alt="" width="100" height="100"/>
                                        </div>
                                      </div>
                                      <div class="quote-fullwidth-body">
                                        <div class="quote-fullwidth-header">
                      ...
                      <div class="item">
                                    <blockquote class="quote-fullwidth">
                                      <div class="quote-fullwidth-left">
                                        <div class="quote-fullwidth-avatar"><img src="theam/images/testimonials-3-100x100.jpg" alt="" width="100" height="100"/>
                                        </div>
                                      </div>
                                      <div class="quote-fullwidth-body">
                                        <div class="quote-fullwidth-header">
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                ...
                <article class="box-post box-post-dark box-post-reverse box-post-image-right-bottom">
                  <div class="box-post-left"><img class="box-post-image" src="theam/images/box-post-1-530x490.png" alt="" width="530" height="490"/>
                  </div>
                ...
                <article class="box-post">
                  <div class="box-post-left"><img class="box-post-image" src="theam/images/box-post-2-530x490.png" alt="" width="530" height="490"/>
                  </div>
                  <div class="box-post-body">
                ...
                <article class="box-post box-post-dark box-post-reverse">
                  <div class="box-post-left"><img class="box-post-image" src="theam/images/box-post-3-530x490.png" alt="" width="530" height="490"/>
                  </div>
                  <div class="box-post-body">
          ...
          <nav class="rd-navbar rd-navbar-default" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed" data-md-layout="rd-navbar-sidebar" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-sidebar" data-stick-up-clone="false">
            <div class="rd-navbar-inner">
              <div class="rd-navbar-panel">
                ...
                <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img src="theam/images/logo-default-199x36.png" alt="" width="199" height="36"/></a></div>
              </div>
    ...
    <div class="modal fade text-center" id="modalWindow" role="dialog">
      <div class="modal-dialog custom-modal-dialog">
        <div class="custom-modal-content">
          ...
          <div class="shell">
            <div class="box-portfolio"><img class="box-portfolio-image" src="theam/images/barbers-single-1-130x130.jpg" alt="" width="130" height="130"/>
	...
	<script type="theam/text/javascript">
	 var _gaq = _gaq || [];
