...
<head>
    ...
    <title>{{ config('app.name', 'wellness') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                        <li class="nav-item">
                        <a class="nav-link" href="{{ route('login') }}">{{ __('EDIT PROFILE') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="{{ route('login') }}">{{ __('SPACILISTS') }}</a>
                        </li>
                            <li class="nav-item dropdown">
